  ...
  return (
    <div className="p-6 lg:pl-20">
      ...
      <Button
        href="#"
        variant="secondary"
        className="group mt-6 w-full text-teal-600"
      >
        Nous contacter
        <ArrowDownIcon className="h-4 w-4 stroke-teal-600 transition group-active:stroke-zinc-600 dark:group-hover:stroke-zinc-50 dark:group-active:stroke-zinc-50" />
      </Button>
    </div>
  )
}
